		...
		"Delhi | Chennai | Hyderabad | London | New York | Mountain view,California <br/><br/>".
				...
				fclose($excel_alive);
							...
							*/
							...
							$sqljd="LOAD DATA LOCAL INFILE '".$newcsvfile."' IGNORE INTO TABLE jt_js_details FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\n' (@NAME1,@email1,@dob,@mobile1,@industry1,@skills1,@cemployer,@cloc,@experience,@ploc,@course1,@spec1,@institute1,@gender1,@func_area,@address1,@username1,@password1,@user_id1) SET id=null, user_id=@user_id1, fname=@NAME1, dob = @dob, email=@email1,gender=@gender1, gender = replace(@gender1, '\"', '')";
							...
							$sqlud="LOAD DATA LOCAL INFILE '".$newcsvfile."' IGNORE INTO TABLE jt_userdetails FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\n' (@NAME1,@email1,@dob,@mobile1,@industry1,@skills1,@cemployer,@cloc,@experience,@ploc,@course1,@spec1,@institute1,@gender1,@func_area,@address1,@username1,@password1,@user_id1) SET id=null, user_id=@user_id1, user_type=1, city=@cloc,mobile = @mobile1, address=@address1,email=@email1,address = replace(@address1, '\"', '')";
							...
							$sqlcd="LOAD DATA LOCAL INFILE '".$newcsvfile."' IGNORE INTO TABLE current_details FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\n' (@NAME1,@email1,@dob,@mobile1,@industry1,@skills1,@cemployer,@cloc,@experience,@ploc,@course1,@spec1,@institute1,@gender1,@func_area,@address1,@username1,@password1,@user_id1) SET id=null, user_id=@user_id1, curr_name=@NAME1, dob = @dob,present_city=@cloc,tot_exp=@experience,gender=@gender1,functional_area=@func_area,industry= @industry1, email=@email1,course=@course1,institute=@institute1,pref_location=@ploc,industry = replace(@industry1, '\"', '')";
							...
							$sqlpaidmoney="LOAD DATA LOCAL INFILE '".$newcsvfile."' IGNORE INTO TABLE jt_ad_info FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\n' (@NAME1,@email1,@dob,@mobile1,@industry1,@skills1,@cemployer,@cloc,@experience,@ploc,@course1,@spec1,@institute1,@gender1,@func_area,@address1,@username1,@password1,@user_id1) SET id=null, user_id=@user_id1, name=@NAME1, email=@email1,amount_paid=600.00,amount_rem=600.00,amount_status='Paid',user_type=1,status='Active'";
