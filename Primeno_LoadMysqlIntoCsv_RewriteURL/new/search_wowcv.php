  ...
  <table width="420" border="0" align="right" cellpadding="0" cellspacing="0">
    <tr>
      <td>
		...
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="title"> WOW CV Search Results</td>
  </tr>
    <tr>
  <td>
  <form  method="post" action="search_wowcv.php">
...
<input type="text" name="keyword" id="keyword" class="txtBox_small" value="<?echo $all_keyword;?>" />
</div>
...
<table border='0' cellpadding="0" cellspacing="0" style="background-image:url(../images/blueBar.png);background-repeat:repeat-x;width:745px;">
  ...
  <td width="167" height="30" class="whiteContent_b" style="padding-left:5px">Videoscript</td>
   <td width="370" height="30" class="whiteContent_b">Details</td>
   <td width="172" height="30" class="whiteContent_b"><a href="search_wowcv.php?or=dtstamp&keyword=<?php echo $all_keyword; ?>&ty=<?php echo $orNext;?>" title="Order by Date" class="whiteContent_bu">Date</a><?php echo imgRes($orBy,"dtstamp");?></td>
   </tr>
...
$z++;
		...
		$query_in="select ws.filename from wow_video_reference wv
				...
				<tr>
                    ...
                    <div class="playbutton" style="position:absolute;cursor:pointer" onclick="window.location='http://www.jobtardis.in/new/playback.php?filename=<?php echo $row_view['filename']; ?>'"></div>
                    <a href="http://www.jobtardis.in/new/playback.php?filename=<?php echo $row_view['filename']; ?>">
                    
                    <img src="http://www.jobtardis.in/wowcv/uploadedImage/<?php echo $own_thumb; ?>"  height="90" width="140" hspace="10" vspace="10" class="imageBorder_wowcv" /></a><br />
				<?php if($ref_cnt>0)
					  {
				?>
				...
				?>  </td>
					...
					echo "<b>Title: </b>".ucfirst($row_view['title']). "<br/>"."<b>Name: </b>".ucfirst($row_view['fname'])." ".$row_view['lname'];
					if($country_city!="")
					{
