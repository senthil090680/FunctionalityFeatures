...
--
-- Database: `jobtarin_india`
--

-- --------------------------------------------------------

--
-- Table structure for table `cities_search`
--

CREATE TABLE IF NOT EXISTS `cities_search` (
...
INSERT INTO `cities_search` (`city_id`, `city_name`, `city_state`) VALUES
