<?php
	$openinviter_settings=array(
		"username"=>"anantha",
		"private_key"=>"2125877cef48ff1cf0218bd525d8ecdb",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to anantha.co.in", // anantha.co.in is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to anantha.co.in", // anantha.co.in is the website on your account. If wrong, please update your account at OpenInviter.com
